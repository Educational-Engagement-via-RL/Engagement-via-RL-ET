...
def initialize():
    ...
    integer_range = range(0, 21)  # Possible page numbers for the fourth dimension

    # Create the state space
    state_space = list(itertools.product(values, familiarity_values, similarity_values, integer_range))
